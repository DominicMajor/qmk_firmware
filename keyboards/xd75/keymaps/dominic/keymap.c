...
/* SPLIT QWERTY
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | ESC    | 1      | 2      | 3      | 4      | 5      | GRAVE  | MINUS  | EQUAL  | 6      | 7      | 8      | 9      | 0      | BSPACE |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | E      | R      | T      | NUM7   | NUM8   | NUM9   | Y      | U      | I      | O      | P      | QUOTE  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | CAPS   | A      | S      | D      | F      | G      | NUM4   | NUM5   | NUM6   | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | NUM1   | NUM2   | NUM3   | N      | M      | COMMA  | DOT    | UP     | SLASH  |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | CTRL   | LGUI   | ALT    | LOWER  | RAISE  | SPACE  | NUM0   | NUM00  | NUM.   | SPACE  | SPACE  | RAISE  | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
	
 [_QW] = { /* SPLIT QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRAVE, KC_MINUS, KC_EQUAL, KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPACE },
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_P7,   KC_P8,   KC_P9,   KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOTE  },
  { KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_P4,   KC_P5,   KC_P6,   KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENTER   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1,   KC_P2,   KC_P3,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_UP, KC_SLASH },
  { KC_LCTRL, KC_LGUI, KC_LALT, MO(_LW), MO(_RS),  KC_SPC,  KC_P0, DOUBLE_ZERO,   KC_PDOT, KC_SPC, KC_SPC,  MO(_RS), KC_LEFT, KC_DOWN, KC_RIGHT  },
 },
 ...
 */
 ...
 [_LW] = { /* LOWERED */
  { CAD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,  KC_F6, KC_F6, KC_F6, KC_F6, KC_F6, KC_F6, KC_F6, KC_DEL  },
 ...
 */
 ...
 [_RT] = { /* RESET */
  ...
  { _______, _______, _______, _______, _______, TERM_ON, _______, _______, _______, _______, _______, _______, _______, _______, KC_PWR },
  { _______, _______, _______, _______, _______, TERM_OFF, _______, RESET,   _______, _______, _______, _______, _______, _______, _______ },
